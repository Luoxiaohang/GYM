...
<link rel="stylesheet"
	href="../../plugin/kindeditor-4.1.4/themes/default/default.css" />
<link rel="stylesheet"
	href="../../plugin/kindeditor-4.1.4/plugins/code/prettify.css" />
					...
					<table width="960px" cellspacing="10px">
						<tr>
							...
							<td><input name="title" type="text"
								class="match-release-title" /></td>
						</tr>
						<tr>
							<td align="right">正文</td>
							<td><textarea name="content" class="match-release-content"></textarea>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td><input name="action" type="hidden" value="add" /> <input
								name="submit" type="submit" id="submit" value="提交" /></td>
						</tr>
					</table>
				</form>
			</div>
